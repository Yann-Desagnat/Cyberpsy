...
import './ProfilDefenseur.css';
import logo from '../../images/logo.png';
import lockImage from '../../images/lock-image.png'; 
import api from '../../../axios';// Utilisation d'axios
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faCarBurst, faPersonMilitaryRifle, faChartPie, faShield, faArchway } from "@fortawesome/free-solid-svg-icons";
...
const ProfilAttaquants = () => {
  ...
  return (
    <>
      ...
      <div class="container">
      <div className="box defenseur" onClick={() => showPopup(1)}>
        <FontAwesomeIcon icon={faCarBurst} size="3x" className="icon-profil" />
      <span className="title-profil">Analyste en réponse aux incident</span></div>

      <div className="box defenseur" onClick={() => showPopup(2)}>
        <FontAwesomeIcon icon={faPersonMilitaryRifle} size="3x" className="icon-profil" />
      <span className="title-profil">Chasseur de menaces</span></div>

      <div className="box defenseur" onClick={() => showPopup(3)}>
        <FontAwesomeIcon icon={faChartPie} size="3x" className="icon-profil" />
      <span className="title-profil">Analyste</span></div>

      <div className="box defenseur" onClick={() => showPopup(4)}>
        <FontAwesomeIcon icon={faShield} size="3x" className="icon-profil" />
      <span className="title-profil">Ingénieur en sécurité</span></div>

      <div className="box defenseur" onClick={() => showPopup(5)}>
        <FontAwesomeIcon icon={faArchway} size="3x" className="icon-profil" />
      <span className="title-profil">Architecte sécurité</span></div>
